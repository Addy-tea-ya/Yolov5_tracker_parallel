           ...
           def __init__(self , opt,tobj):
                    ...
                    # Second-stage classifier
                      ...
                      if classify:
                          ...
                          modelc.load_state_dict(torch.load('weights/resnet101.pt', map_location=device)['model']).to(self.device).eval()
...
##                                            time.sleep(0.1)
           ...
           def runcode(self):
                      ...
                      while e :
                                 ...
                                 img0 = img0.half() if self.half else img0.float()
                                 img0 /= 255.0
                      ...
                      try :
                                 while True:
                                            ...
                                            if(len(ts)==2):
                                                ...
                                                #Angle1=angle(ts)
                                                #ser.write(bytes(str(int(Angle1)),'utf-8'))
                                            elif(len(ts)==1):
                                                ts.remove(ts[0])
                                                tim+=1
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='C:/Users/Aditya/Downloads/best.pt', help='model.pt path(s)')
